...
print("Summer ",limitValue,"toplam_TimeC:",toplam_TimeC,"\nSummer ",limitValue,"Summer toplam_TimeC2:",toplam_TimeC2)
...
print("Summer ",limitValue,"1.1:",toplam_TimeC/1000,"\nSummer ",limitValue,"1.5:",toplam_YeniTimeC/1000)
gündüzFatura=0
puantFatura=0
geceFatura=0
tekzfatura=0
...
print("Summer ",limitValue,"  Smart triple-time tariff bill:",ToplamFatura,"TL\nSummer ",limitValue,"Smart single-time tariff bill:",tekzfaturatutar,"TL")
print("Summer ",limitValue,"  Standart triple-time tariff:",ToplamFatura2,"TL\nSummer ",limitValue," Standart single-time tariff bill:",tekzfaturatutar2,"TL")
